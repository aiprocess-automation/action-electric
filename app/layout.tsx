...
const limelight = Limelight({
  subsets: ['latin'],
  weight: '400',
  variable: '--font-energetic-display',
  display: 'swap',
})
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html
      ...
      className={`${inter.variable} ${roboto.variable} ${limelight.variable} ${playfair.variable} ${poppins.variable} ${archivoBlack.variable}`}
    >
      <body>
        <script
